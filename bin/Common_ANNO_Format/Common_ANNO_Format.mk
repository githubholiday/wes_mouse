...
Cut_Anno_file:
	...
	$(python3) $(script)/CutFileByChr.py -i $(indir) -t $(type) -s $(sample) -g $(genome)
...
chr1:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr1.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr1.$(type).$(genome)_multianno.xls
	@echo
...
chr2:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr2.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr2.$(type).$(genome)_multianno.xls
	@echo
...
chr3:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr3.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr3.$(type).$(genome)_multianno.xls
	@echo
...
chr4:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr4.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr4.$(type).$(genome)_multianno.xls
	@echo
	@echo `date "+%Y-%m-%d %H:%M:%S"` "-Annotation Format CHR-INFO- ####### Annotation Format <chr4> End"
	@echo
chr5:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr5.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr5.$(type).$(genome)_multianno.xls
	@echo
...
chr6:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr6.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr6.$(type).$(genome)_multianno.xls
	@echo
...
chr7:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr7.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr7.$(type).$(genome)_multianno.xls
	@echo
...
chr8:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr8.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr8.$(type).$(genome)_multianno.xls
	@echo
...
chr9:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr9.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr9.$(type).$(genome)_multianno.xls
	@echo
...
chr10:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr10.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr10.$(type).$(genome)_multianno.xls
	@echo
...
chr11:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr11.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr11.$(type).$(genome)_multianno.xls
	@echo
...
chr12:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr12.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr12.$(type).$(genome)_multianno.xls
	@echo
...
chr13:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr13.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr13.$(type).$(genome)_multianno.xls
	@echo
...
chr14:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr14.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr14.$(type).$(genome)_multianno.xls
	@echo
...
chr15:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr15.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr15.$(type).$(genome)_multianno.xls
	@echo
...
chr16:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr16.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr16.$(type).$(genome)_multianno.xls
	@echo
...
chr17:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr17.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr17.$(type).$(genome)_multianno.xls
	@echo
...
chr18:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr18.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr18.$(type).$(genome)_multianno.xls
	@echo
...
chr19:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr19.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr19.$(type).$(genome)_multianno.xls
	@echo
...
chr20:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr20.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr20.$(type).$(genome)_multianno.xls
	@echo
...
chr21:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr21.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr21.$(type).$(genome)_multianno.xls
	@echo
...
chr22:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chr22.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chr22.$(type).$(genome)_multianno.xls
	@echo
...
chrX:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chrX.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chrX.$(type).$(genome)_multianno.xls
	@echo
...
chrY:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).chrY.$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).Format.chrY.$(type).$(genome)_multianno.xls
...
chr_all:
	...
	@echo
	-$(PERL) $(script)/Format.pl -annovar $(infile).$(type).$(genome)_multianno.txt -title $(title_document) -output $(infile).$(type).$(genome)_multianno.Format.xls
	@echo
