...
os.system("/annoroad/share/software/install/bcftools/bcftools-1.5/bin/bcftools concat -a -Ov -o %s/all_SV.vcf %s" %(output_dir,input_list))
...
os.system("/annoroad/share/software/install/bin/bedtools intersect -a %s/all_SV_filtered.bed -b %s -wao > %s/all_SV_filtered.overlap.gene_model.tsv" %(output_dir,input_BED,output_dir))
